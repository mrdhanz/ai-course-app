...
export default function SearchResultsPage() {
    ...
    return (
        <div className="min-h-screen bg-parchment dark:bg-dark-gray flex flex-col items-center pb-12">
            {/* Google-like Header */}
            <header className="fixed top-0 left-0 right-0 bg-white dark:bg-gray-900 shadow-md z-20 py-3 px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between gap-3">
                {/* Logo/Home Link */}
